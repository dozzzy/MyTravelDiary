                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                ...
                                // [START_EXCLUDE silent]
                                txtVerify.setError("Invalid code.");
                                // [END_EXCLUDE]
                            }
                            // [START_EXCLUDE silent]
                            // Update UI
...
//                enableViews(btnStart, txtPhone);
//                disableViews(btnStart, btnVerify);
//                //mDetailText.setText(null);
//                break;
//            case STATE_CODE_SENT:
//                // Code sent state, show the verification field, the
//                enableViews(btnVerify,txtPhone,txtVerify);
//                disableViews(btnStart);
//                //mDetailText.setText(R.string.status_code_sent);
//                break;
//            case STATE_VERIFY_FAILED:
//                // Verification has failed, show all options
//                enableViews(btnStart,btnVerify,txtVerify,txtPhone);
...
//                        txtVerify.setText(cred.getSmsCode());
//                    } else {
//                        txtVerify.setText("invalid");
//                    }
//                }
//
//                break;
